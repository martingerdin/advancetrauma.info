...
const contributors: TeamMember[] = [
  {
    ...
    roles: ['Principal Investigator', 'Trial Management Group chair'],
  ...
  },
  {
    ...
    roles: ['Associate Project Manager', 'Trial Management Group member'],
  ...
  },
  {
    ...
    affiliation:
      'Institute of Post Graduate Medical Education & Research and Seth Sukhlal Karnani Memorial Hospital, Kolkata, India',
    roles: ['Trial Management Group member', 'Site investigator'],
  ...
  },
  {
    ...
    roles: ['Collaborator', 'External statistician'],
  ...
  },
  {
    ...
    affiliation: 'The George Institute for Global Health, New Delhi, India',
    roles: ['Clinical Research Associate', 'Trial Management Group member'],
  },
]
